...
public class HealBossScript : MonoBehaviour
{
    ...
    IEnumerator destroyObj()
    {
        ...
        //tmpobj.GetComponent<PotionFireScript>().Setdamage(healAmount);
        ...
        if (!m_bUpdateCheck)
            ...
            if ( other.CompareTag("Boss") )
            {
                ...
                this.transform.SetParent(other.transform);
                    ...
                    Boss2Health Boss2Health = other.transform.root.GetComponent<Boss2Health>();
                    Vector2 dir = new Vector2(0, 0);
                    //tmp_Player.Damaged(1, dir);
                     Boss2Health.GetHeal(healAmount);
